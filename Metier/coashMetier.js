class CoashMetier {
    ...
    add() {  
        ...
        this.Consult();
            ...
            var salaire = document.getElementById('montantP').value;
            ...
            this.coash = new Coash(idC, nomC, prenomC, emailC, telC, addressC, categorieC, salaire);
            console.log( salaire);
        ...
        if (this.isUpdate == true) {
            for (let index = 0; index < ERP.Coash.length; index++) {
                if (this.CoashUpdate.id == ERP.Coash[index].id) {
                    this.coash = new Coash(this.coashUpdate.id, nomC, prenomC, emailC, addressC, telC, categorieC, salaire);
    ...
    show() {
        ...
        for (let i = 0; i<ERP.Coash.length; i++) {
            ...
            html+= '<strong>Email :</strong>'+ ERP.Coash[i].email
            html+= '</p><p>'
            html+= '<strong>Tel :</strong>'+  ERP.Coash[i].tel 
            html+='</p><p>'
            html+='<strong>Address :</strong>'+  ERP.Coash[i].address 
            html+='</p><p>'
            html+= '<strong>categorie :</strong>'+ ERP.Coash[i].categorie 
            html+= '</p>'
            html+= '</p> <strong>salaire :</strong>'+ ERP.Coash[i].salaire+'<p>'
    ...
    delete(iFDelete) {
     ...
     Pass() {
        var pswd = document.getElementById('pswdP');
        var categorieC = document.getElementById('categorieP');
if(categorieC.value =="Coash")
{
