class ManagerMetier {
    ...
    show() {
        ...
        for (let i = 0; i<ERP.Manager.length; i++) {
            ...
            html+='<strong>Email :</strong>'+ ERP.Manager[i].email
            html+= '</p><p>'
            html+= '<strong>Tel :</strong>'+ ERP.Manager[i].tel 
            html+='</p><p>'
            html+= '<strong>Adresse :</strong>'+ERP.Manager[i].address 
            html+='</p><p>'
            html+= '<strong>Categorie :</strong>'+ERP.Manager[i].categorie 
            html+= '</p> <p>'
           html+='<strong>salaire :</strong>'+ ERP.Manager[i].salaire 
            html+= '</p>'
